...
type PRODUCT struct {
	PID       string `json:"pid" db:"pid" form:"pid"`
	Pname     string `json:"pname" db:"pname" form:"pname"`
	...
	Status    uint8  `json:"status" db:"status" form:"status"`
	Linkid    int32  `json:"linkid" db:"linkid" form"linkid"`
